...
const Color primary = Color(0xffFEBD11);
const Color secondary=Color(0xffCE2A31);
const Color fontColor=Colors.black;
const Color grad1Color=Color(0xffFEBD11);
const Color grad2Color=Color(0xffFEBD11);
